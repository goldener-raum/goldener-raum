<template>
  <div class="ma12">
    ...
    <p>
      Die Vertrauensgesellschaft e.V. hat als für die Verarbeitung
    ...
    <p>
      Die Datenschutzerklärung der Vertrauensgesellschaft e.V. beruht auf den
    ...
    <p>Vertrauensgesellschaft e.V.</p>
    <p>Isarstrasse 11</p>
    <p>12053 Berlin</p>
    <p>Deutschland</p>
    <p>Tel.: 0177123123123</p>
    <p>E-Mail: support@expedition-grundeinkommen.de</p>
    <p>Website: https://www.goldenerraum.de</p>

    <h2>3. Erfassung von allgemeinen Daten und Informationen</h2>
    <p>
      Die Internetseite der Vertrauensgesellschaft e.V. erfasst mit jedem Aufruf
    ...
    <p>
      ...
      Vertrauensgesellschaft e.V. keine Rückschlüsse auf die betroffene Person.
    ...
    <p>
      ...
      sowie das Datum und die Uhrzeit der Anmeldung. Die Erhebung dieser Daten
      ist erforderlich, um den(möglichen) Missbrauch der E-Mail-Adresse einer
      betroffenen Person zu einem späteren Zeitpunkt nachvollziehen zu können
    ...
    <p>
      ...
      entsprechender Link. Ferner besteht die Möglichkeit, sich jederzeit auch
      direkt auf der Internetseite des für die Verarbeitung Verantwortlichen vom
      Newsletterversand abzumelden oder dies dem für die Verarbeitung
      Verantwortlichen auf andere Weise mitzuteilen.
    </p>

    <h2>5. Newsletter-Tracking</h2>
    <p>
      Die Newsletter der Vertrauensgesellschaft e.V. enthalten sogenannte
      ...
      Zählpixels kann die Vertrauensgesellschaft e.V. erkennen, ob und wann eine
    ...
    <p>
      ...
      Newsletters deutet die Vertrauensgesellschaft e.V. automatisch als
      Widerruf.
    </p>
    ...
    <ul style="list-style: none">
      ...
      <li>
        ...
        <p>
          ...
          Vertrauensgesellschaft e.V. gespeichert sind, veranlassen möchte, kann
          sie sich hierzu jederzeit an einen Mitarbeiter des für die
          Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der
          Vertrauensgesellschaft e.V. wird veranlassen, dass dem Löschverlangen
        ...
        <p>
          ...
          nicht erforderlich ist. Der Mitarbeiter der Vertrauensgesellschaft
      ...
      <li>
        ...
        <p>
          ...
          bei der Vertrauensgesellschaft e.V. gespeichert sind, verlangen
          ...
          Vertrauensgesellschaft e.V. wird die Einschränkung der Verarbeitung
          veranlassen.
        </p>
      </li>
      <li>
        ...
        <p>
          ...
          Vertrauensgesellschaft e.V. wenden.
        </p>
      </li>
      <li>
        ...
        <p>
          Die Vertrauensgesellschaft e.V. verarbeitet die personenbezogenen
        ...
        <p>
          Verarbeitet die Vertrauensgesellschaft e.V. personenbezogene Daten, um
          ...
          Vertrauensgesellschaft e.V. der Verarbeitung für Zwecke der
          Direktwerbung, so wird die Vertrauensgesellschaft e.V. die
        ...
        <p>
          ...
          Vertrauensgesellschaft e.V. zu wissenschaftlichen oder historischen
        ...
        <p>
          ...
          Person direkt an jeden Mitarbeiter der Vertrauensgesellschaft e.V.
      ...
      <li>
        ...
        <p>
          ...
          betroffenen Person, trifft die Vertrauensgesellschaft e.V. angemessene
