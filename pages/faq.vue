<template>
  <div class="ma12">
    ...
    <p>
      ...
      Kerngruppe gemeinschaftlich auf der Plattform elinor.network -
      demokratisch und transparent für alle Beteiligten. Hier wird ganz
      praktisch Geld als soziales und innovatives Gestaltungsmittel erprobt.
    </p>
    <p>
      Über das Geld hinaus ist der kreative Austausch und die gegenseitige
      Unterstützung das Wesentliche des goldenen Raumes, in Events und digitalen
      Austauschformaten. Es geht um Potenzialentfaltung, um das Erleben von
      Selbstwirksamkeit und darum, mit Menschen aus anderen Herkünften und
      sozialen Hintergründen in Verbindung zu kommen.
    </p>
    ...
    <h2>Welche Organisationen stehen dahinter?</h2>
    <p>
      Unterstützt wird der goldene Raum auch von der GLS Bank und Organisationen
      der Aktivist*innen.
    </p>

    <h2>Was bedeutet „goldener Raum“?</h2>
    <p>
      Die Bezeichnung „Goldener Raum“ ist im Gespräch über die Lebensphase vor
      dem Berufsleben entstanden. Es wurde deutlich, wie wesentlich diese Zeit
      für biographische und gesellschaftliche Entwicklungen sein kann.
      Allerdings gibt es auch einen zunehmenden Druck, möglichst schnell und
    ...
    <p>
      ...
      Sozialgenossenschaft das Café Pala. Auf dessen Dach treffen sich im Sommer
      2021 junge Aktivist*innen. Die einen kämpfen gegen die Klimakrise, die
      anderen wollen die Obdachlosigkeit beenden. Trotz aller Gemeinsamkeiten
      wurde schnell klar, wie unterschiedlich die Herkünfte und die Bedarfe
      sind. Die einen brauchen Ressourcen, um das Klima auf die öffentliche
      Agenda zu setzen, die anderen möchten Entwicklungsschritte von einzelnen
      Menschen ermöglichen, hin zu mehr Selbstwirksamkeit und gesunden
      Lebensverhältnissen. Es schien naheliegend, diese unterschiedlichen
      Bedarfe in getrennten Gruppen zu organisieren. Als dies jedoch so
      ausgesprochen wurde, stockte allen der Atem: Ist nicht genau eine solche
      Trennung die Ursache vieler Probleme? Sollten für den Klimaaktivismus
      nicht auch persönliche Entwicklungsschritte und für die Abschaffung der
      Obdachlosigkeit nicht auch politische Aktivitäten wichtig werden? Und wenn
      unsere Bildungshintergründe so verschieden sind: Macht das nicht genau die
      gesellschaftliche Spaltung aus, die wir so dringend überwinden müssen? Wie
      cool wären denn Peergroups, in denen beides zusammenfließt? – Damit war
      die Idee zum goldenen Raum geboren.
    </p>

    <h2>Was ist anders als bei Spenden?</h2>
    <p>
      Im goldenen Raum werden einzelne Aktivist*innen unterstützt, für ihre
